 ...
 * @author John Keates
 */
public class FilemakerDatabase extends AbstractDatabase {

    private List<Schema> schemas;
    private static final JooqLogger log = JooqLogger.getLogger(FilemakerDatabase.class);


    public FilemakerDatabase() {
        // FilemakerDatabase doesn't know schemata
        org.jooq.meta.jaxb.Schema schema = new org.jooq.meta.jaxb.Schema();
        schema.setInputSchema("");
        schema.setOutputSchema("");

        List<org.jooq.meta.jaxb.Schema> schemata = new ArrayList<org.jooq.meta.jaxb.Schema>();
        schemata.add(schema);
...
//    }
    ...
    protected List<CatalogDefinition> getCatalogs0() throws SQLException {
        ...
        result.add(new CatalogDefinition(this, "", "Default set by jooq"));
        return result;
    }
    ...
    protected List<SchemaDefinition> getSchemata0() throws SQLException {
        ...
        result.add(new SchemaDefinition(this, "", "Default set by jooq"));
...
//        }
    ...
    protected List<TableDefinition> getTables0() throws SQLException {
        ...
        for (Schema schema : getSchemasFromMeta()) {
            ...
            if (sd != null) {
                for (Table<?> table : schema.getTables()) {
                    log.info("Adding table: " + table.getName());
                    result.add(new FilemakerTableDefinition(sd, table));
                }
            }
        }
        return result;
